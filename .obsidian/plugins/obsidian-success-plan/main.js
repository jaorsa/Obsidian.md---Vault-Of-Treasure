...
function HorizontalTabs(Props) {
  function getStyling(tab) {
    //                                           css_comment: Active Tab Color
    return Props.activeTab == tab ? { fontWeight: "bold", fontFamily: "Rubik,Avenir,Helvetica,Arial,sans-serif", borderTopLeftRadius: "0.375rem", borderTopRightRadius: "0.375rem", borderBottomLeftRadius: "0.375rem", borderBottomRightRadius: "0.375rem", fontWeight: "700", fontSize: ".875rem",  boxShadow: "0 0 transparent,0 0 transparent,0 10px 15px -3px rgba(0,0,0,0.1),0 4px 6px -2px rgba(0,0,0,0.05)", color: "rgba(255,255,255,1)", textTransform: "uppercase", background: "linear-gradient(130deg, #24c6dc, #5433ff 41.07%, #ff0099 76.05%)", marginTop: "1rem", marginBottom: "1rem", marginRight: ".75rem", paddingLeft: "1.5rem", paddingRight: "1.5rem" } : { fontWeight: "normal", color: "white", marginTop: "1rem", marginBottom: "1rem", marginRight: ".75rem", backgroundColor: "#1a1a1a", borderTopLeftRadius: "0.375rem", borderTopRightRadius: "0.375rem", borderBottomLeftRadius: "0.375rem", borderBottomRightRadius: "0.375rem", paddingLeft: "1.5rem", paddingRight: "1.5rem", textAlign:"center", color: "#bebebe", fontFamily: "Rubik,Avenir,Helvetica,Arial,sans-serif" }; //css_comment: Tab (color)
  }
  return /* @__PURE__ */ React3.createElement("div", {
    style: { display: "flex", flexDirection: "row", justifyContent: "space-evenly", background: "#212121", borderTopLeftRadius: "1rem", borderTopRightRadius: "1rem", borderBottomLeftRadius: "1rem", borderBottomRightRadius: "1rem", marginBottom: "2rem", height: "3.5rem" }
  }, /* @__PURE__ */ React3.createElement("p", {
    style: getStyling("Task"),
    onClick: () => Props.tabClickHandler("Task")
  }, "Tasks"), /* @__PURE__ */ React3.createElement("p", {
    style: getStyling("Project"),
    onClick: () => Props.tabClickHandler("Project")
  }, "Projects"), /* @__PURE__ */ React3.createElement("p", {
    style: getStyling("Key Result"),
    onClick: () => Props.tabClickHandler("Key Result")
  }, "Key Results"), /* @__PURE__ */ React3.createElement("p", {
    style: getStyling("Goal"),
    onClick: () => Props.tabClickHandler("Goal")
  }, "Goals"));
}

// src/components/ItemModal.ts
...
function uppercaseFirstCharOverMultipleWordsWithReplaceSeparator(text, oldSeparator, newSeparator) {
...
function lowercaseAndReplaceSep(text, oldSeparator, newSeparator) {
  return text.toLowerCase().replaceAll(oldSeparator, newSeparator);
}

// src/components/ItemModal.ts
var ItemModal = class extends import_obsidian.Modal {
  constructor(app, dateFormat, action, successPlanItem, onSubmit) {
    super(app);
    __publicField(this, "onSubmit");
    __publicField(this, "successPlanItem");
    __publicField(this, "action");
    __publicField(this, "isValidName");
  ...
  onOpen() {
    ...
    new import_obsidian.Setting(contentEl).setName("Name").addText((text) => text.setValue(this.successPlanItem.name ? this.successPlanItem.name : "").onChange((value) => {
    ...
    new import_obsidian.Setting(contentEl).setName("Description").addText((text) => text.setValue(this.successPlanItem.description ? this.successPlanItem.description : "").onChange((value) => {
      this.successPlanItem.description = value;
    }));
    new import_obsidian.Setting(contentEl).setName("Type").addDropdown((cb) => cb.addOptions({ task: "Task", project: "Project", key_result: "Key Result", goal: "Goal" }).setValue(this.successPlanItem.type ? this.successPlanItem.type.toLowerCase().replace(" ", "_") : "").onChange((val) => __async(this, null, function* () {
      this.successPlanItem.type = val.includes("_") ? "Key Result" : uppercaseFirstChar(val);
    })));
    new import_obsidian.Setting(contentEl).setName("Impact").addDropdown((cb) => cb.addOptions({ low: "Low", s_low: "S-Low", medium: "Medium", s_high: "S-High", high: "High" }).setValue(this.successPlanItem.impact ? this.successPlanItem.impact.toLowerCase().replaceAll(" ", "_") : "").onChange((val) => __async(this, null, function* () {
    ...
    new import_obsidian.Setting(contentEl).setName("Status").addDropdown((cb) => cb.addOptions({ ready_to_start: "Ready to Start", next_up: "Next Up", in_progress: "In Progress", complete: "Complete", backlog: "Backlog", canceled: "Canceled" }).setValue(this.successPlanItem.status ? this.successPlanItem.status.toLowerCase().replaceAll(" ", "_") : "").onChange((val) => __async(this, null, function* () {
    ...
    if (this.successPlanItem.type == "Task") {
      new import_obsidian.Setting(contentEl).setName("Difficulty").addSlider((cb) => cb.setLimits(1, 10, 1).setValue(this.successPlanItem.difficulty ? this.successPlanItem.difficulty : null).onChange((val) => __async(this, null, function* () {
        this.successPlanItem.difficulty = val;
      })).setDynamicTooltip());
    }
    new import_obsidian.Setting(contentEl).setName("Do Date").addMomentFormat((cb) => cb.setDefaultFormat(this.dateFormat).setValue(this.successPlanItem.do_date != "" ? this.successPlanItem.do_date.format(this.dateFormat) : "").onChange((val) => __async(this, null, function* () {
      this.successPlanItem.do_date = (0, import_obsidian.moment)(val);
    })));
    new import_obsidian.Setting(contentEl).setName("Due Date").addMomentFormat((cb) => cb.setDefaultFormat(this.dateFormat).setValue(this.successPlanItem.due_date != "" ? this.successPlanItem.due_date.format(this.dateFormat) : "").onChange((val) => __async(this, null, function* () {
      this.successPlanItem.due_date = (0, import_obsidian.moment)(val);
    })));
    new import_obsidian.Setting(contentEl).setName("Closing Date").addMomentFormat((cb) => cb.setDefaultFormat(this.dateFormat).setValue(this.successPlanItem.closing_date != "" ? this.successPlanItem.closing_date.format(this.dateFormat) : "").onChange((val) => __async(this, null, function* () {
      this.successPlanItem.closing_date = (0, import_obsidian.moment)(val);
    })));
    if (this.successPlanItem.type == "Task") {
      new import_obsidian.Setting(contentEl).setName("Tag (Mins Per Pomodoro)").addDropdown((cb) => cb.addOptions({ 25: "25 mins", 5: "5 Mins" }).setValue(this.successPlanItem.tag != "" ? this.successPlanItem.tag : "").onChange((val) => __async(this, null, function* () {
        this.successPlanItem.tag = parseInt(val);
      })));
    }
    new import_obsidian.Setting(contentEl).setName("Area (Goals Only)").addDropdown((cb) => cb.addOptions({
      career: "Career",
      family: "Family",
      finances: "Finances",
      health: "Health",
      ...
      travel: "Travel"
    }).setValue(this.successPlanItem.area ? this.successPlanItem.area.toLowerCase().replace(" ", "_") : "").onChange((val) => __async(this, null, function* () {
    ...
    new import_obsidian.Setting(contentEl).addButton((btn) => btn.setClass("modal_submit_btn").setButtonText(this.action == "EDIT" ? "UPDATE" : "Create").setCta().onClick(() => {
      if (this.isValidName) {
        if (this.action == "EDIT" && this.successPlanItem.name != this.originalName) {
          this.onSubmit(__spreadProps(__spreadValues({}, this.successPlanItem), { name_was_edited: true }));
        } else {
          this.onSubmit(this.successPlanItem);
        }
        this.close();
      } else {
        new import_obsidian.Notice("Invalid Name. Please choose a different name.");
      }
    }));
  }
  ...
  var elem = function(conf) {
    ...
    return import_react3.default.createElement("svg", __assign({
      ...
      style: __assign(__assign({
        color: props.color || conf.color //css_comment: Button icon color `+`
...
// src/ReactApp.tsx
function ReactApp(settings) {
  const { vault, workspace } = useApp();
  const [successPlanItems, setSPItems] = (0, import_react4.useState)(null);
  const [successPlanObjects, setSPObjects] = (0, import_react4.useState)(null);
  const [activeTab, setTab] = (0, import_react4.useState)("Task");
  const BASE_GOLD = 50;
  let baseHideLedgerValues = { ready_to_start: true, next_up: true, in_progress: true, complete: true, backlog: true, canceled: true };
  const [taskHideLedger, setTaskHideLedger] = (0, import_react4.useState)(__spreadProps(__spreadValues({}, baseHideLedgerValues), { next_up: false, in_progress: false }));
  const [projectHideLedger, setProjectHideLedger] = (0, import_react4.useState)(__spreadProps(__spreadValues({}, baseHideLedgerValues), { in_progress: false }));
  const [keyResultHideLedger, setKeyResultHideLedger] = (0, import_react4.useState)(__spreadProps(__spreadValues({}, baseHideLedgerValues), { in_progress: false }));
  const [goalHideLedger, setGoalHideLedger] = (0, import_react4.useState)(__spreadProps(__spreadValues({}, baseHideLedgerValues), { in_progress: false }));
  ...
  function getTotalGold(itemDifficulty) {
    return /* @__PURE__ */ React7.createElement("p", null, "+", BASE_GOLD * itemDifficulty, " \u{1F4B0}");
  }
  function getImpactStyling(impact) {
    ...
    switch (impact) {
      case "Low":
        return __spreadProps(__spreadValues({}, baseStyling), { backgroundColor: "#44494d80" });
      case "S Low":
        return __spreadProps(__spreadValues({}, baseStyling), { backgroundColor: "#88542b80" });
      case "Medium":
        return __spreadProps(__spreadValues({}, baseStyling), { backgroundColor: "#32524180" });
      case "S High":
        return __spreadProps(__spreadValues({}, baseStyling), { backgroundColor: "#92763f80" });
      case "High":
        return __spreadProps(__spreadValues({}, baseStyling), { backgroundColor: "#79363b80" });
      default:
        break;
    }
  }
  ...
  function generateList(array) {
    ...
    result = array.map((item, index) => /* @__PURE__ */ React7.createElement("div", {
      style: { display: "flex", flexDirection: "row", justifyContent: "space-between" },
      key: index,
      className: "item",
      onClick: (event) => handleItemClick(event, item)
    }, /* @__PURE__ */ React7.createElement("p", null, item.name), /* @__PURE__ */ React7.createElement("div", {
      style: { display: "flex", flexDirection: "row", alignItems: "center" }
    }, item.impact ? /* @__PURE__ */ React7.createElement("p", {
      style: getImpactStyling(item.impact)
    }, item.impact.replace(" ", "-"), " \u{1F44A}") : null, /* @__PURE__ */ React7.createElement("p", {
      style: isGamificationOn && item.difficulty ? { marginRight: "10px" } : { marginRight: "0px" }
    }, determinePunctionality(item)), isGamificationOn && item.difficulty ? getTotalGold(item.difficulty) : null)));
    return result;
  }
  function determinePunctionality(item) {
    ...
    if (doDateStr == "") {
      ...
      return "\u{1F6A8} Late " + Math.floor(calculateDifferenceBetweenGivenDates(doDate, closingDate)) + " day(s)!";
    } else if (doDate < new Date()) {
      return "\u{1F6A8} Late " + Math.floor(calculateDifferenceBetweenGivenDates(doDate, new Date())) + " day(s)!";
    }
  }
  function calculateDifferenceBetweenGivenDates(date1, date2) {
    var timeDifference = date2.getTime() - date1.getTime();
    var dayDifference = timeDifference / (1e3 * 3600 * 24);
    return dayDifference;
  }
  function getSuccessPlanItems() {
    let files = [];
    const path = "Quick-Start-Vault/Success Plan";
    ...
    if (folder instanceof import_obsidian2.TFolder) {
      ...
      for (let j = 0; j < successPlanFolders.length; j++) {
        ...
        if (successPlanFolder instanceof import_obsidian2.TFolder) {
  ...
  function getSuccessPlanObjects() {
    return __async(this, null, function* () {
      let result = [];
      for (let i = 0; i < successPlanItems.length; i++) {
        result.push(yield parseFile(successPlanItems[i]));
      }
      setSPObjects(result);
    });
  }
  function parseFile(file) {
    return __async(this, null, function* () {
      ...
      let itemContent = yield vault.cachedRead(file);
  ...
  function getValueFromTagStr(text) {
    let result;
  ...
  function getValueFromStreamOrDateStr(text) {
    let result;
    let secondHalf = text.split("::")[1].trim();
    if (text.includes("Date")) {
      if (secondHalf.includes("[[")) {
        result = (0, import_obsidian2.moment)(secondHalf.replace("[[", "").replace("]]", ""));
      } else {
        result = secondHalf;
      }
    } else {
  ...
  function getItemsOfGivenTypeAndStatus(itemType, itemStatus) {
    let result = [];
  ...
  function getItemTitleOnly(name) {
    return name.split("-")[1].trim().replace(".md", "");
  }
  function replaceTextInFile(file, fileContent, oldText, newText) {
    return __async(this, null, function* () {
      yield vault.modify(file, fileContent.replace(oldText, newText));
    });
  }
  function changeStatusOfSuccessPlanItem(successPlanItem, newStatus) {
    return __async(this, null, function* () {
      yield replaceTextInFile(successPlanItem.file, successPlanItem.full_content, successPlanItem.status.toLowerCase().replaceAll(" ", "-"), newStatus);
    });
  }
  function updateSuccessPlanItem(successPlanItem) {
    return __async(this, null, function* () {
      yield vault.modify(successPlanItem.file, prepareFileContent(successPlanItem));
      resetSuccessPlanItemState();
    });
  }
  function updateAndRenameSuccessPlanItem(successPlanItem) {
    return __async(this, null, function* () {
      yield vault.create("Quick-Start-Vault/Success Plan/" + successPlanItem.type + "s/" + successPlanItem.type + " - " + successPlanItem.name + ".md", prepareFileContent(successPlanItem));
      yield vault.trash(successPlanItem.file, true);
      resetSuccessPlanItemState();
    });
  }
  ...
  function showContextMenu(event, successPlanItem) {
    return __async(this, null, function* () {
      const { dateFormat } = settings.settings;
      const menu = new import_obsidian2.Menu(this.app);
      menu.addItem((item) => item.setTitle("Edit").setIcon("pencil").onClick(() => __async(this, null, function* () {
        new ItemModal(this.app, dateFormat, "EDIT", successPlanItem, (result) => __async(this, null, function* () {
          new import_obsidian2.Notice(`Updated File: ${result.type} - ${result.name}`);
          if (result.name_was_edited) {
            yield updateAndRenameSuccessPlanItem(result);
          } else {
            yield updateSuccessPlanItem(result);
          }
        })).open();
      })));
      menu.addItem((item) => item.setTitle("Ready to Start").setIcon("navigate-glyph").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "ready-to-start");
        resetSuccessPlanItemState();
      })));
      menu.addItem((item) => item.setTitle("Next Up").setIcon("right-chevron-glyph").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "next-up");
        resetSuccessPlanItemState();
      })));
      menu.addItem((item) => item.setTitle("In Progress").setIcon("wrench-screwdriver-glyph").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "in-progress");
        resetSuccessPlanItemState();
      })));
      menu.addItem((item) => item.setTitle("Complete").setIcon("checkmark").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "complete");
        resetSuccessPlanItemState();
      })));
      menu.addItem((item) => item.setTitle("Backlog").setIcon("box-glyph").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "backlog");
        resetSuccessPlanItemState();
      })));
      menu.addItem((item) => item.setTitle("Canceled").setIcon("cross").onClick(() => __async(this, null, function* () {
        yield changeStatusOfSuccessPlanItem(successPlanItem, "canceled");
        resetSuccessPlanItemState();
      })));
  ...
  function handleSectionHideClick(section) {
    switch (activeTab) {
      case "Task":
        setTaskHideLedger(__spreadProps(__spreadValues({}, taskHideLedger), { [section]: !getTabLedgerSectionHideValue(section) }));
        break;
      case "Project":
        setProjectHideLedger(__spreadProps(__spreadValues({}, projectHideLedger), { [section]: !getTabLedgerSectionHideValue(section) }));
        break;
      case "Key Result":
        setKeyResultHideLedger(__spreadProps(__spreadValues({}, keyResultHideLedger), { [section]: !getTabLedgerSectionHideValue(section) }));
        break;
      case "Goal":
        setGoalHideLedger(__spreadProps(__spreadValues({}, goalHideLedger), { [section]: !getTabLedgerSectionHideValue(section) }));
        break;
      default:
        break;
    }
  }
  function getTabLedgerSectionHideValue(section) {
  ...
  function generateSections() {
    ...
    for (let i = 0; i < SECTIONS.length; i++) {
      ...
      result.push(/* @__PURE__ */ React7.createElement("div", {
        key: i,
        style: { display: "flex", flexDirection: "column" }
      }, /* @__PURE__ */ React7.createElement("div", {
        style: { display: "flex", flexDirection: "row", alignItems: "center" }
      }, /* @__PURE__ */ React7.createElement("h3", {                                                       /* color: "transparent", backgroundImage: "linear-gradient(130deg, rgb(36, 198, 220), rgb(84, 51, 255) 41.07%, rgb(255, 0, 153) 76.05%)", backgroundClip: "text", WebkitBackgroundClip: "text" */
        style: { marginRight: 5, fontFamily: "Rubik,Avenir,Helvetica,Arial,sans-serif", color: "#24c6dc"  } // css_comment: Status color
      }, SECTIONS[i].includes("To") ? SECTIONS[i].replace("To", "to") : SECTIONS[i]), list.length != 0 ? /* @__PURE__ */ React7.createElement("p", {
        onClick: () => handleSectionHideClick(lowercaseSection)
      }, getTabLedgerSectionHideValue(lowercaseSection) ? "unhide" : "hide") : null), getTabLedgerSectionHideValue(lowercaseSection) ? null : list));
    }
    return result;
  }
  function convertDateStringToFormat(dateStr) {
  ...
  function FABClick() {
    ...
    const { dateFormat } = settings.settings;
    new ItemModal(this.app, dateFormat, "CREATE", defaultItem, (result) => __async(this, null, function* () {
      new import_obsidian2.Notice(`New ${result.type} Created`);
      yield createSuccessPlanItem(result);
    })).open();
  }
  ...
  return /* @__PURE__ */ React7.createElement(React7.Fragment, null, /* @__PURE__ */ React7.createElement(HorizontalTabs, {
    tabClickHandler: handleTabClick,
    activeTab
  }), successPlanObjects ? /* @__PURE__ */ React7.createElement(React7.Fragment, null, generateSections()) : null, /* @__PURE__ */ React7.createElement(Fab, {
    mainButtonStyles: { background: "linear-gradient(rgb(7, 31, 66), #42083f)", borderTop: "#23e5f3af 2px solid", borderLeft:"#34ec7ab9 1px solid", boxShadow: "inset -4px -4px 4px -3px #cc0aa2d0", backgroundColor: "transparent", marginRight: "0px" }, // css_comment: Button color
    style: { bottom: 5, right: 5, marginRight: "1rem" },
    icon: /* @__PURE__ */ React7.createElement(MdAdd, null),
...
// src/view.tsx
var VIEW_TYPE_SUCCESS_PLAN = "success-plan-view";
var SuccessPlanView = class extends import_obsidian3.ItemView {
  ...
  onOpen() {
    return __async(this, null, function* () {
      ReactDOM.render(/* @__PURE__ */ React8.createElement(AppContext.Provider, {
        value: this.app
      }, /* @__PURE__ */ React8.createElement(ReactApp, {
...
var SuccessPlanPlugin = class extends import_obsidian4.Plugin {
  constructor() {
    super(...arguments);
  ...
  onload() {
    return __async(this, null, function* () {
      ...
      this.registerView(VIEW_TYPE_SUCCESS_PLAN, (leaf) => new SuccessPlanView(leaf, this));
      let ribbonIconEl = this.addRibbonIcon("navigate-glyph", "Success Plan Plugin", (evt) => {
        this.activateView();
      });
  ...
  activateView() {
    return __async(this, null, function* () {
      ...
      this.app.workspace.revealLeaf(this.app.workspace.getLeavesOfType(VIEW_TYPE_SUCCESS_PLAN)[0]);
    });
  }
  onunload() {
...
var SuccessPlanSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Gamification").setDesc("If disabled, this will cause the total gold for tasks to be hidden.").addToggle((cb) => cb.setValue(this.plugin.settings.isGamificationOn).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.isGamificationOn = value;
      yield this.plugin.saveSettings();
      yield this.plugin.onunload();
      new import_obsidian4.Notice("Please restart plugin.");
    })));
    new import_obsidian4.Setting(containerEl).setName("Date Format").setDesc("Use the date format that you use for your daily notes, ex. MM DD YYYY").addText((text) => text.setPlaceholder("Date Format").setValue(this.plugin.settings.dateFormat).onChange((value) => __async(this, null, function* () {
